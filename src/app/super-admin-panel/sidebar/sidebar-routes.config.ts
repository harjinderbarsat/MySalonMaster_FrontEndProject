...
export const SUPER_ADMIN_ROUTES: RouteInfo[] = [
  { path: '/super-admin/dashboard', title: 'Dashboard', icon: 'fa fa-tachometer', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], visibility: true, isAdmin: false },
  // { path: '/super-admin/employees', title: 'Manage Admins', icon: 'ft-users', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [], visibility: true, isAdmin: true },
